...
The search script lives inside this skill's own directory, not the application source.
Resolve its absolute path from `.codex/skills/ui-ux-pro-max/` before invoking
it. The examples below assume the repository root is the working directory:
